...
def training_main(args, model_cls, forward_step_function, create_dataset_function, handle_metrics_function=None, init_function=None, collate_fn=None, forward_step_eval=None):
    ...
    if args.train_iters > 0:
        ...
        # lr_scheduler = get_learning_rate_scheduler(optimizer, args.iteration, args, auto_warmup_steps=1500)
        # Warmup leads to certain issues, closed.
    ...
    while args.iteration < args.train_iters:
        ...
        if args.iteration % args.log_interval == 0:
            ...
            if report_memory_flag:
                ...
                report_memory_flag = False  # TODO: comment/remove this.
