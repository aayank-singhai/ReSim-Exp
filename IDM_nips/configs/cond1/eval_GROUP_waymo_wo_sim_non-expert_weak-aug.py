...
gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_Action_Control_wo_sim_1cond_fixed/GROUP_waymo_wo_sim_non_expert_1cond'
