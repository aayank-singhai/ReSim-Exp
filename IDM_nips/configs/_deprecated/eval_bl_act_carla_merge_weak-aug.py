...
data = dict(
    ...
    val=dict(
        ...
        # gen_image_root='/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/waymo_action_control/GROUP_full_action_center_main2_30k',
        # gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_add_carla_data_act',
        # gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_add_carla_data_act2_early_carla',
        gen_image_root = "/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_add_carla_data_act_merge",
    ...
    test=dict(
        ...
        data_root=data_root,
        ann_file= "/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/custom_data/waymo/v2/waymo_val_traj_cmd_v2_sub.json",
        # gen_image_root='/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_full_action_center_main2_30k',
