...
data = dict(
    ...
    val=dict(
        ...
        gen_image_root='/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/waymo_action_control/GROUP_full_free_center_main2_30k',
    ...
    test=dict(
        ...
        # gen_image_root='/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_full_free_center_main2_30k',
        gen_image_root='/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/waymo_action_control/GROUP_full_free_center_main2_30k',
