...
gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/Vista-main/outputs_hdd/GROUP_vista_non_expert'
...
infer_ann_file = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/custom_data/waymo/v2/waymo_val_traj_cmd_v2_mini_sub_uniform_540_shuffled_traj_with_vista_traj.json'
