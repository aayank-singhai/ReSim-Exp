...
# gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_Action_Control_w_sim_resumed/GROUP_waymo_w_sim_non-expert'

gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_Non_Expert_compare_Vista/waymo_wo_sim_non-expert_split0'
infer_ann_file = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/custom_data/waymo/v2/waymo_val_traj_cmd_v2_mini_sub_uniform_540_shuffled_traj.json'
