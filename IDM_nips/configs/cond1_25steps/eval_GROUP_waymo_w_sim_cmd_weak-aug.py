...
gen_image_root = '/cpfs01/user/yangjiazhi/workspace/DVGen/CogVideo/outputs_hdd/GROUP_Action_Control_w_sim_resumed_1cond_25steps/GROUP_waymo_w_sim_cmd_1cond'
